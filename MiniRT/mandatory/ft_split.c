...
/*   Updated: 2025/08/01 22:21:31 by vloddo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	word_len(char *s, unsigned int start, char end)
{
	int	i;
...
static char	**fill_split(char **dest, char *s, char c, int words)
{
	int	i;
	int	j;
	int	k;
